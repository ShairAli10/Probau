    ...
    init: function () {
        ...
        !(function () {
            ...
            a &&
                new ApexCharts(a, {
                    series: [
                        { name: "Net Profit", data: [6, 9, 12, 6, 15, 19] },
                    ],
                    chart: {
                        fontFamily: "inherit",
                        type: "bar",
                    ...
                    xaxis: {
                        categories: [
                            ...
                            "Sat",
                            "Sun",
                        ], // Replace Feb with Mon and Mar with Tue
                        axisBorder: { show: !1 },
                        axisTicks: { show: !1 },
                ...
                // user detail chart 
                (a = document.getElementById("user_time_chart_widget_chart")),
            (o = parseInt(KTUtil.css(a, "height"))),
            (s = KTUtil.getCssVariableValue("--bs-gray-500")),
            (r = KTUtil.getCssVariableValue("--bs-gray-200")),
            (i = KTUtil.getCssVariableValue("--bs-primary")),
        ...
        // AGE DISTRIBUTION CHART
            ...
            (function () {
                var e,
                    t = document.querySelectorAll(".user-matches-widget-chart");
                [].slice.call(t).map(function (t) {
                    e = parseInt(KTUtil.css(t, "height"));
