                ...
                <div class="grid grid-cols-1 sm:grid-cols-1 md:grid-cols-2 gap-10 ">
                    ...
                    <div id="contactForm">
                        <div class="">
                            ...
                            <input class="input-form mt-3 mb-6" type="text" name="name" id="name" required
                        ...
                        <div class="">
                            ...
                            <input class="input-form mt-3 mb-6" type="text" name="phone" id="phone" required
                        ...
                        <div class="">
                            ...
                            <textarea class="text-form mt-3 mb-6" cols="30" rows="5" type="text" name="message" id="message"
