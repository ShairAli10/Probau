    ...
    <div id="kt_header" class="header">
        ...
        <div class="container-fluid d-flex align-items-center justify-content-between">
            ...
            <div class="page-title d-flex flex-column align-items-start justify-content-center flex-wrap me-lg-2 pb-2 pb-lg-0"
                ...
                <!--begin::Heading-->
                <h1 class="d-flex flex-column text-dark fw-bold my-0 fs-1">Private User Management
                </h1>
                <!--end::Heading-->
            </div>
            <!--end::Page title=-->
                    ...
                    @else
                        <div class=" text-center">
                            <img alt="Logo" style="align-items: center; margin-top:50px"
                                src="{{ url('frontend/media/noPrivateUser.png') }}" class="img-fluid ">
                        </div>
                    @endif
                </div>
...
<script>
    ...
    function loadVerificationData(page, search = '', sortingOption = '') {
        ...
        $.ajax({
            url: '{{ route('PrivateUsers') }}?page=' + page + '&search=' + search + '&sorting=' +
                sortingOption,
            method: 'GET',
            dataType: 'json',
        ...
        `;
                    ...
                    <tr>
                        ...
                        <td style = "padding-left:30px;">${row.project_count}</td>
                        <td class="">
                        ...
                        <td class="text-end">
                            <div class="fs-5 fw-bolder text-dark">
                                <a href="{{ URL::to('UserDetail') }}/${row.id}" class="link-danger fw-bolder">
                                    Visit Profile
                                </a>
                            </div>
                        </td>
