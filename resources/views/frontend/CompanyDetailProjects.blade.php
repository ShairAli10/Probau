    ...
    function loadVerificationData(page, search = '', sortingOption = '') {
        ...
        `;
                    ...
                    <tr>
                        ...
                        <td class="">
                            ${row.status == 1 ?
                                `<a class="link-primary fw-bolder fs-6" style = "color: #009ef7 !important;">Open</a>` :
                            row.status == 2 ?
                                `<a class="link-warning fw-bolder fs-6" style = "color: #ffc700 !important;" >In Progress</a>` :
                                `<a class="link-success fw-bolder fs-6" style = "color: #50cd89 !important;" >Completed</a>`}
                        </td>
                        <td class="text-end">
                            <div class="fs-5 fw-bolder text-dark">
                                <a href="{{ URL::to('ProjectDetail') }}/${row.id}" class="link-danger fw-bolder" style = "color: #f1416c !important;">
                                    View Details
                                </a>
                            </div>
                        </td>
