...
<script>
    ...
    function loadVerificationData(page) {
        ...
        $.ajax({
            url: '{{ route('SubscriptionPayments') }}?page=' + page,
            method: 'GET',
            dataType: 'json',
        ...
        `;
                    ...
                    <tr>
                        <td class="d-flex align-items-center">
                            ${row.company.profile_pic ? `
                                <div class="symbol symbol-50px overflow-hidden me-3">
                                    <div class="symbol-label">
                                        <img src="{{ asset('storage/') }}/${row.company.profile_pic}" alt="image" class="w-100" />
                                    </div>
                                </div>` : `
                                <div class="symbol symbol-50px overflow-hidden me-3">
                                    <div class="symbol-label">
                            ...
                            <div class="d-flex flex-column">
                                ...
                                <span>${row.company.email}</span>
                            </div>
                        </td>
                        <td>${row.plan_detail.name}</td>
                        <td>${row.charges_detail.name}</td>
                        <td class= "text-danger fw-bolder" style = "padding-left:20px;">€${row.charges_detail.price}</td>
