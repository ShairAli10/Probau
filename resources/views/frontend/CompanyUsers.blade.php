    ...
    <div id="kt_header" class="header">
        ...
        <div class="container-fluid d-flex align-items-center justify-content-between">
            ...
            <div class="page-title d-flex flex-column align-items-start justify-content-center flex-wrap me-lg-2 pb-2 pb-lg-0"
                ...
                <!--begin::Heading-->
                <h1 class="d-flex flex-column text-dark fw-bold my-0 fs-1">Company Users Management
                </h1>
                <!--end::Heading-->
            </div>
            <!--end::Page title=-->
        ...
        <div class="container-fluid" id="">
            ...
            <div class="card">
                ...
                <div class="card-header border-0 pt-6">
                    ...
                    <div class=" mb-5">
                        <!--begin::Title-->
                        <h3 class="mt-4" style=" font-weight:400; ">Total Companies: <span class="fs-5" id="user-count"
                        ...
                        <div class="d-flex justify-content-between " data-kt-user-table-toolbar="base">
                            ...
                            <div class="menu menu-sub menu-sub-dropdown w-300px w-md-325px" data-kt-menu="true">
                                ...
                                <div class="px-7 py-5" data-kt-user-table-filter="form">
                                    <!--begin::Input group-->
                                    <div class="mb-10">
                                        <label class="form-label fs-6 fw-bold">Request Date:</label>
                                        <select id="request-date-filter" class="form-select form-select-solid fw-bolder"
                                    ...
                                    <div class="d-flex justify-content-end">
                                        ...
                                        <button type="submit" id="apply-filter-button"
                                            class="btn btn-primary fw-bold px-6" data-kt-menu-dismiss="true"
                    ...
                    @else
                        <div class=" text-center">
                            <img alt="Logo" style="align-items: center; margin-top:50px"
                                src="{{ url('frontend/media/noCompanyFound.png') }}" class="img-fluid ">
                        </div>
                    @endif
                </div>
...
<script>
    ...
    function loadVerificationData(page, search = '', sortingOption = '') {
        ...
        $.ajax({
            url: '{{ route('CompanyUsers') }}?page=' + page + '&search=' + search + '&sorting=' +
                sortingOption,
            method: 'GET',
            dataType: 'json',
            success: function(response) {
                ...
                if (users.data.length === 0) {
                    ...
                    var noUserRow = `
            <tr>
                <td colspan="6" class="text-center pt-10 fw-bolder fs-2">No Company found</td>
            </tr>
        `;
                    ...
                    $.each(users.data, function(index, row) {
                        var companyTypeNames = row.company_type.map(function(company_type) {
                    ...
                    <tr>
                            ...
                            ${row.profile_pic ? `
                                <div class="symbol symbol-50px overflow-hidden me-3">
                                    <div class="symbol-label">
                                        <img src="{{ asset('storage/') }}/${row.profile_pic}" alt="image" class="w-100" />
                                    </div>
                                </div>` : `
                                <div class="symbol symbol-50px overflow-hidden me-3">
                                    <div class="symbol-label">
                        ...
                        <td class= "truncate">${companyTypeHtml}</td>
                        <td class= "truncate">${row.location}</td>
                        <td>${row.no_employee}</td>
                        <td class="">
                            <div class="fs-5 fw-bolder text-dark">
                                <a  class="link-success fw-bolder">
                                    Active
                                </a>
                            </div>
                        </td>
                        <td class="text-end">
                            <div class="fs-5 fw-bolder text-dark">
                                <a href="{{ URL::to('CompanyDetail') }}/${row.id}" class="link-danger fw-bolder">
                                    Visit Profile
                                </a>
                            </div>
                        </td>
