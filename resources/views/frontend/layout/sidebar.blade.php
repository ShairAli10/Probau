  ...
  <div id="kt_aside" class="aside py-9" data-kt-drawer="true" data-kt-drawer-name="aside"
      ...
      <div class="aside-logo flex-column-auto px-9 mb-9" id="kt_aside_logo">
          ...
          <a href="{{ URL::to('Dashboard') }}">
              <img alt="Logo" src="{{ '../frontend/media/sidebarlogo.png' }}" />
          </a>
          <!--end::Logo-->
      </div>
      <!--end::Brand-->
      ...
      <div class="aside-menu flex-column-fluid ps-5 pe-3 mb-9" id="kt_aside_menu">
          ...
          <div class="w-100 hover-scroll-overlay-y pe-2" id="kt_aside_menu_wrapper" data-kt-scroll="true"
              ...
              <div class="menu menu-column menu-rounded fw-bold my-auto" id="#kt_aside_menu" data-kt-menu="true">
                  <div class="menu-item">
                      <a class="menu-link  {{ request()->is('PrivateUser') ? 'active' : '' }}"
                          href="{{ URL::to('PrivateUser') }}">
                          <span class="menu-icon">
                              <!--begin::Svg Icon | path: icons/duotune/arrows/arr001.svg-->
                              <span class="menu-bullet">
                                  <span class="bullet bullet-dot"></span>
                          ...
                          <span class="menu-title">Private User</span>
                      </a>
                  </div>
              ...
              <div class="menu menu-column menu-rounded fw-bold my-auto" id="#kt_aside_menu" data-kt-menu="true">
                  <div class="menu-item">
                      <a class="menu-link  {{ request()->is('CompanyUser') ? 'active' : '' }}"
                          href="{{ URL::to('CompanyUser') }}">
                          <span class="menu-icon">
                              <!--begin::Svg Icon | path: icons/duotune/arrows/arr001.svg-->
                              <span class="menu-bullet">
                                  <span class="bullet bullet-dot"></span>
              ...
              <div class="menu menu-column menu-rounded fw-bold my-auto" id="#kt_aside_menu" data-kt-menu="true">
                  <div class="menu-item">
                      <a class="menu-link  {{ request()->is('AllProjects') || request()->is('UserProject') ? 'active' : '' }}"
                          href="{{ URL::to('AllProjects') }}">
                          <span class="menu-icon">
                              <!--begin::Svg Icon | path: icons/duotune/arrows/arr001.svg-->
                              <span class="menu-bullet">
                                  <span class="bullet bullet-dot"></span>
              ...
              <div class="menu menu-column menu-rounded fw-bold my-auto" id="#kt_aside_menu" data-kt-menu="true">
                  <div class="menu-item">
                      <a class="menu-link  {{ request()->is('PaymentHistory') ? 'active' : '' }}"
                          href="{{ URL::to('PaymentHistory') }}">
                          <span class="menu-icon">
                              <!--begin::Svg Icon | path: icons/duotune/arrows/arr001.svg-->
                              <span class="menu-bullet">
                                  <span class="bullet bullet-dot"></span>
              ...
              <div class="menu menu-column menu-rounded fw-bold my-auto" id="#kt_aside_menu" data-kt-menu="true">
                  <div class="menu-item">
                      <a class="menu-link  {{ request()->is('CompanyTypes') ? 'active' : '' }}"
                          href="{{ URL::to('CompanyTypes') }}">
                          <span class="menu-icon">
                              <!--begin::Svg Icon | path: icons/duotune/arrows/arr001.svg-->
                              <span class="menu-bullet">
                                  <span class="bullet bullet-dot"></span>
              ...
              <div class="menu menu-column menu-rounded fw-bold my-auto" id="#kt_aside_menu" data-kt-menu="true">
                  <div class="menu-item">
                      <a class="menu-link  {{ request()->is('Mail') ? 'active' : '' }}" href="{{ URL::to('Mail') }}">
                          <span class="menu-icon">
                              <!--begin::Svg Icon | path: icons/duotune/arrows/arr001.svg-->
                              <span class="menu-bullet">
                                  <span class="bullet bullet-dot"></span>
              ...
              <div class="menu menu-column menu-rounded fw-bold my-auto" id="#kt_aside_menu" data-kt-menu="true">
                  <div class="menu-item">
                      <a class="menu-link  {{ request()->is('ContactUS') ? 'active' : '' }}"
                          href="{{ URL::to('ContactUS') }}">
                          <span class="menu-icon">
                              <!--begin::Svg Icon | path: icons/duotune/arrows/arr001.svg-->
                              <span class="menu-bullet">
                                  <span class="bullet bullet-dot"></span>
              ...
              <div class="menu menu-column menu-rounded fw-bold my-auto" id="#kt_aside_menu" data-kt-menu="true">
                <div class="menu-item">
                    <a class="menu-link  {{ request()->is('Requests') ? 'active' : '' }}"
                        href="{{ URL::to('Requests') }}">
                        <span class="menu-icon">
                            <!--begin::Svg Icon | path: icons/duotune/arrows/arr001.svg-->
                            <span class="menu-bullet">
                                <span class="bullet bullet-dot"></span>
                        ...
                        <span class="menu-title">Delete Account Requests</span>
                    </a>
                </div>
      ...
      <div class="aside-logo flex-column-auto px-9 mb-9" id="kt_aside_logo">
          ...
          <div class="d-flex align-items-center">
              ...
              <div class="symbol symbol-circle symbol-40px">
                  <img src="{{ '../frontend/media/admin.png' }}" alt="photo" />
              </div>
              <!--end::Avatar-->
              <!--begin::User info-->
              <div class="ms-2">
              ...
              <div class="btn btn-sm btn-icon btn-active-color-white position-relative me-n2"
