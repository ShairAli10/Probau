                    ...
                    <div class="table-responsive">
                            ...
                            <table class="table table-row-dashed table-row-gray-300 align-middle gs-0 gy-4">
                                ...
                                <thead>
                                    <tr class="text-start text-muted fw-bolder fs-5 text-uppercase gs-0">
                                        <th class="min-w-175px">Project Name</th>
                                        <th class="min-w-175px text-center">Uploaded Date</th>
                                        <th class="min-w-175px text-center">Description</th>
                                ...
                                <tbody class="text-gray-600 fw-bold">
                                    @foreach ($response['company_users'] as $row)
                                        <tr>
                                            ...
                                            <td class="fw-normal fs-4">
                                                {{ $row->description }}
                                            </td>
                                            <td class="text-center">
                                                <div class="fs-5 fw-bolder text-dark">
                                                    <a href="{{ URL::to('PastProjectDetail/' . $row->id) }}" class="link-danger fw-bolder" style = "color: #f1416c !important;">
                                                        View Detail
                                                    </a>
                                                </div>
                                            </td>
                        ...
                        @else
                            <div class="col" style="text-align: center;">
                                <img alt="Logo" src="{{ url('frontend/media/noPastProject.svg') }}"
                                    class="img-fluid">
                            </div>
                        @endif
