    ...
    <div id="kt_header" class="header">
        <div class="container-fluid d-flex align-items-center justify-content-between">
            ...
            <div class="page-title d-flex flex-column align-items-start justify-content-center flex-wrap me-lg-2 pb-2 pb-lg-0"
                ...
                <!--begin::Heading-->
                <h1 class="d-flex flex-column text-dark fw-bolder my-0 fs-1">Company types
                </h1>
                    ...
                    <table class="table align-middle table-row-dashed" id="userTable">
                        ...
                        <thead>
                            <tr class="text-start tbl-head">
                                <th class="min-w-300px ">Sr No</th>
                                <th class="min-w-300px ">Category</th>
                                <th class="min-w-300px ">No of services</th>
                        ...
                        <tbody class="fs-6 fw-bold ">
                            ...
                            @foreach ($data as $index => $row)
                                <tr>
                                    ...
                                    <td class="text-muted ps-10">
                                        {{ $row->services }}
                                    </td>
                                    <td class="button-container text-end d-flex align-content-end justify-content-end">
                                        <button type="button" class="btn btn-sm btn-primary text-light edit-btn p-0"
                                            ...
                                            Edit</button>
                                        {{-- <button type="button "
                                              class="btn btn-sm btn-danger delete-btn text-light delete-interest p-0"
                                              data-interest-id="{{ $row->id }}" style="height: 40px;
                                              width: 100px;">
                                              <span class="">
                                                  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                                      viewBox="0 0 24 24" fill="none">
                                        ...
                                        <div class="ms-7">
                                            <a href="{{ URL::to('Services/' . $row->id) }}"
                                                class="link-danger fw-bolder">View Services</a>
                                        </div>
                                    </td>
                                </tr>
                            @endforeach
            ...
            @else
                <div class=" text-center">
                    <img alt="Logo" style="align-items: center; margin-top:50px"
                        src="{{ url('frontend/media/NoCType.png') }}" class="img-fluid ">
                </div>
            @endif
            ...
            <div class="modal-dialog mw-650px">
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body  pt-4 mx-0">
                        <!--begin::Input group-->
                        <form action="AddCompanyType/" method="get" class="form" enctype="multipart/form-data">
                            @csrf
                            <div class="fv-row mb-5">
                                <!--begin::Input-->
                                <label for="name" class="fw-bold fs-6 pb-2 fw-600">Business type</label> <input
                                    type="text" class="form-control form-control-solid"
                                    placeholder="Enter Company type" name="name" required />
                                <!--end::Input-->
                            </div>
        ...
        <div class="modal fade" id="kt_modal_update_interests" tabindex="-1" aria-hidden="true">
            ...
            <div class="modal-dialog mw-650px">
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body  pt-4 mx-0">
                        <!--begin::Input group-->
                        <form action="{{ route('company_type_update', ['id' => 'interest_id']) }}" method="post"
                            ...
                            <div class="fv-row mb-5">
                                <!--begin::Input-->
                                <label for="name" class="fw-bold fs-6 pb-2 fw-600">Business type</label>
                ...
                $('.delete-interest').click(function() {
                    ...
                    Swal.fire({
                        ...
                        if (result.isConfirmed) {
                            $.ajax({
                                type: "GET",
                                url: 'category_delete/' + interestId,
