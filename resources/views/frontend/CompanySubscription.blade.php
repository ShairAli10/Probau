            ...
            <div class="card card-flush mb-5 mb-xl-10" style="background-color: none; max-height:350px;">
                <div class="card-body" style="overflow-y: auto; ">
                    <div class="table-responsive">
                        @if (count($response['subscriptions']))
                            <!--begin::Table-->
                            <table class="table table-row-dashed table-row-gray-300 align-middle gs-0 gy-4">
                                <!--begin::Table head-->
                                <thead>
                                    <tr class="text-start text-muted fw-bolder fs-5 text-uppercase gs-0">
                                        <th class="min-w-125px">Subscription Name</th>
                                        <th class="min-w-125px text-center">Package Name</th>
                                        <th class="min-w-125px text-center">Amount</th>
                                        <th class="min-w-125px text-center">Added On</th>
                                ...
                                <tbody class="text-gray-600 fw-bold">
                                    @foreach ($response['subscriptions'] as $row)
                                        <tr>
                                            <td class="">
                                                {{ $row->plan_detail->name }}
                                            </td>
                                            <td class="text-center">
                                                {{ $row->charges_detail->name }}
                                            </td>
                                            <td class="text-center text-danger fw-bolder ">
                                                €{{ $row->charges_detail->price }}
                                            </td>
                                            <td class="text-center">
                                                {{ \Carbon\Carbon::createFromFormat('d/m/Y', $row->start_date)->format('M d, Y') }}
                                            </td>
                                            <td class="text-center">
                                                {{ \Carbon\Carbon::createFromFormat('d/m/Y', $row->end_date)->format('M d, Y') }}
                                            </td>
                                            <td class="text-center">
                                                @if ($row->status == 0)
                                                    <a class="link-danger fw-bold" style="color: #f1416c !important;">
                                                        Expired
                                                    </a>
                                                @else
                                                    <a class="link-success fw-bold" style="color: #009ef7 !important;">
                                                        Current
                                                    </a>
                                                @endif
                                            </td>
                        ...
                        @else
                            <div class="col" style="text-align: center;">
                                <img alt="Logo" src="{{ url('frontend/media/noSubscription.png') }}"
                                    class="img-fluid">
                            </div>
                        @endif
