        ...
        <div class="container-fluid" id="">
            ...
            <div class="card card-flush mb-5 mb-xl-10" style="background-color: none; max-height:350px;">
                <div class="card-body" style="overflow-y: auto; ">
                    <div class="row">
                        @if (count($response['reviews']))
                            @foreach ($response['reviews'] as $row)
                                <div class="col-6 mb-6">
                                    <div class="box pt-2  hover-effect d-block">
                                        <div class="row  pb-1">
                                            <div class="col-8 d-flex">
                                                @if ($row->profile_pic == '')
                                                    <div
                                                        class="symbol symbol-circle symbol-100px symbol-lg-160px symbol-fixed position-relative">
                                                        <img src="{{ url('frontend/media/blank.png') }}" alt="image"
                                                ...
                                                @else
                                                    <div
                                                        class="symbol symbol-circle symbol-100px symbol-lg-160px symbol-fixed position-relative">
                                                        <img src="{{ asset('public/storage/' . $row->profile_pic) }}"
                                                    ...
                                                    <div class="  text-muted fs-5">
                                                        <span class="">
                                                            <svg xmlns="http://www.w3.org/2000/svg" width="16"
                                                                ...
                                                                <path
                                                                    d="M5.76159 3.2267C6.77491 1.4089 7.28157 0.5 8.03906 0.5C8.79655 0.5 9.30321 1.4089 10.3165 3.2267L10.5787 3.69699C10.8666 4.21355 11.0106 4.47183 11.2351 4.64225C11.4596 4.81266 11.7392 4.87592 12.2984 5.00244L12.8074 5.11762C14.7752 5.56284 15.759 5.78545 15.9931 6.53818C16.2272 7.29092 15.5565 8.07526 14.215 9.64394L13.8679 10.0498C13.4867 10.4955 13.2961 10.7184 13.2104 10.9942C13.1246 11.2699 13.1534 11.5673 13.2111 12.162L13.2635 12.7035C13.4664 14.7965 13.5678 15.843 12.9549 16.3082C12.3421 16.7734 11.4209 16.3492 9.57852 15.5009L9.10187 15.2815C8.57832 15.0404 8.31655 14.9199 8.03906 14.9199C7.76158 14.9199 7.4998 15.0404 6.97625 15.2815L6.4996 15.5009C4.6572 16.3492 3.736 16.7734 3.12318 16.3082C2.51036 15.843 2.61177 14.7965 2.81458 12.7035L2.86705 12.162C2.92468 11.5673 2.9535 11.2699 2.86775 10.9942C2.78201 10.7184 2.5914 10.4955 2.2102 10.0498L1.86314 9.64394C0.521662 8.07526 -0.149078 7.29092 0.0849993 6.53818C0.319076 5.78545 1.30295 5.56284 3.27069 5.11762L3.77977 5.00244C4.33894 4.87592 4.61853 4.81266 4.84302 4.64225C5.06751 4.47183 5.21148 4.21355 5.49944 3.69699L5.76159 3.2267Z"
                                                                    fill="#F2C925" />
                                                            </svg>
                                                        </span>
                                                        <span class="pt-7">
                                            ...
                                            <div class="col-4 d-flex justify-content-end align-content-end">
                                                <div class="p text-end text-muted">
                                                    {{ \Carbon\Carbon::parse($row->created_at)->diffForHumans() }}
                                                </div>
                                            </div>
                                        </div>
                                        <div class="row pb-4">
                                            <div class="col mt-3 text-muted fs-6" style="height: 50px;">
                                                {{ strlen($row->message) > 120 ? substr($row->message, 0, 120) . '...' : $row->message }}
                                            </div>
                                        </div>
                                        <div class="row d-flex flex-column">
                                            <div class="col text-dark fw-bold fs-3">
                                                Project
                                            </div>
                                            <div class="col text-danger fs-4">
                                                {{ $row->project_name }}
                                            </div>
                                        </div>
                                    </div>
                        ...
                        @else
                            <div class="col" style="text-align: center;">
                                <img alt="Logo" src="{{ url('frontend/media/noReviews.png') }}" class="img-fluid">
                            </div>
                        @endif
                    </div>
                </div>
