    ...
    <div id="kt_header" class="header">
        ...
        <div class="container-fluid d-flex align-items-center justify-content-between">
            ...
            <div class="page-title d-flex flex-column align-items-start justify-content-center flex-wrap me-lg-2 pb-2 pb-lg-0"
                ...
                <!--begin::Heading-->
                <h1 class="d-flex flex-column text-dark fw-bold my-0 fs-1">Delete Account Requests
                </h1>
                <!--end::Heading-->
                            ...
                            <table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_table_users">
                                ...
                                <thead>
                                    ...
                                    <tr class="text-start text-dark fw-bold fs-7 text-uppercase gs-0">
                                        ...
                                        <th class="min-w-275px text-center">Reason</th>
                    ...
                    @else
                        <div class=" text-center">
                            <img alt="Logo" style="align-items: center; margin-top:50px"
                                src="{{ url('frontend/media/NoRequestHistory.png') }}" class="img-fluid ">
                        </div>
                    @endif
                </div>
...
<script>
    ...
    function loadVerificationData(page, search = '', sortingOption = '') {
        ...
        $.ajax({
            url: '{{ route('GetRequests') }}?page=' + page + '&search=' + search + '&sorting=' +
                sortingOption,
            method: 'GET',
            dataType: 'json',
        ...
        `;
                    ...
                    $.each(users.data, function(index, row) {
                        var newRow = `
                    <tr>
                        <td class = "text-dark fw-bold">${row.email}</td>
                        <td>${row.reason}</td>
                        <td class="text-center">
                            <div class="fs-5 fw-bolder text-dark">
                                <a href="{{ URL::to('DeleteRequestDetail') }}/${row.email}" class="link-danger fw-bolder">
                                    View detail
                                </a>
                            </div>
                        </td>
